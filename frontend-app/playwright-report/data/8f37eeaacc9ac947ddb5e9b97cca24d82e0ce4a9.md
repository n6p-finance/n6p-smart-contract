...
```
Error: expect.toBeVisible: Error: strict mode violation: getByRole('heading', { name: 'Decision History' }) resolved to 2 elements:
    1) <h1 class="text-2xl font-bold text-gray-900 mb-4">AI Decision History</h1> aka getByRole('heading', { name: 'AI Decision History' })
    2) <h3 class="text-lg font-semibold">Decision History</h3> aka getByRole('heading', { name: 'Decision History', exact: true })

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByRole('heading', { name: 'Decision History' })

    at /home/mamenesia/Repository/Web3/napfi_ai/frontend-app/e2e/decisions.spec.ts:12:75
```
