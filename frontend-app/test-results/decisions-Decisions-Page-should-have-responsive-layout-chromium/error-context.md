...
- Name: Decisions Page >> should have responsive layout
- Location: /home/mamenesia/Repository/Web3/napfi_ai/frontend-app/e2e/decisions.spec.ts:54:7
...
Locator: getByTestId('mcp-decision-card').locator('xpath=ancestor::div[contains(@class, "lg:col-span-2")]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByTestId('mcp-decision-card').locator('xpath=ancestor::div[contains(@class, "lg:col-span-2")]')

    at /home/mamenesia/Repository/Web3/napfi_ai/frontend-app/e2e/decisions.spec.ts:72:35
```
