...
- Name: Strategies Page >> should display all strategy cards
- Location: /home/mamenesia/Repository/Web3/napfi_ai/frontend-app/e2e/strategies.spec.ts:4:7

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: getByText('Aave Lending') resolved to 2 elements:
    1) <h3 class="text-lg font-semibold">Aave Lending</h3> aka getByRole('heading', { name: 'Aave Lending' })
    2) <p class="text-gray-600 mb-4">Deposit assets into Aave lending pools to earn in…</p> aka getByText('Deposit assets into Aave')

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Aave Lending')

    at /home/mamenesia/Repository/Web3/napfi_ai/frontend-app/e2e/strategies.spec.ts:15:50
```
